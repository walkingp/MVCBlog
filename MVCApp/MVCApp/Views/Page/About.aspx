...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    About - WALKINGP's blog
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">

<h3>About WALKINGP</h3>
<p><img alt="walkingp" src="http://walkingp.com/assets/images/walkingp.jpg" /></p>
<p>坐标上海，一个很菜的C#软件工程师，略懂Java、Python，写过Android程序。</p>
