<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<MVCApp.Models.Users>" %>
...
<div class="container">
    ...
    <form class="form-signin">
        ...
        <%=Html.TextBoxFor(m=>m.Name,new {PlaceHolder="User Name", @class="input-block-level"}) %>
        <%=Html.PasswordFor(x => x.Pwd,new {PlaceHolder="Password", @class="input-block-level"}) %>
