...
<div class="row">
    <div class="col-md-12">
        ...
        <%using (Html.BeginForm("SavePlace", "Manage", FormMethod.Post, new {  @class = "form-horizontal" }))
      { %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        var marker;
        function initialize() {
            var location = new google.maps.LatLng('39.90403','116.407526');
